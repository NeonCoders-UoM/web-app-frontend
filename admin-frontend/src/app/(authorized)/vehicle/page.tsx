      ...
      <div className="flex-1 p-[58px]">
        ...
        <div className="flex justify-between items-center mb-[36px]">
          <div className="relative">
            ...
            >
              <option value="All All Vehicles">All Vehicles</option>
              <option value="Active All Vehicles">Active Vehicles</option>
              <option value="Inactive All Vehicles">Inactive Vehicles</option>
            </select>
