...
const ServiceRequestsPage: React.FC = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50">
      <Sidebar role="admin" activeRoute="/services" />
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="px-4 py-2 bg-blue-600 text-gray-400 rounded-md hover:bg-blue-700 transition-all shadow-md hover:shadow-lg font-medium text-sm"
                          >
                            Approve
                          </button>
                          <button
                            onClick={() => handleReviewClick(request, "rejected")}
                            className="px-4 py-2 bg-red-700 text-gray-400 rounded-md hover:bg-red-800 transition-all shadow-md hover:shadow-lg font-medium text-sm"
                          >
                            Reject
                          </button>
                        </div>
